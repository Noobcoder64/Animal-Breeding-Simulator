...
public class SimulatorView extends JFrame {
	 ...
	 */
	public void showStatus(int step, TimeStorage time, Weather weather, Field field) {
		if (!isVisible()) {
			setVisible(true);
		}
		...
		timeLabel.setText(DAY_PREFIX + time.getDays() + " " + TIME_PREFIX + time.getHours() + ":" + time.getMinutes());

		weatherLabel.setText(
				WEATHER_PREFIX + weather.getConditionString() + " " + RAINING_PREFIX + weather.isRainingString());
